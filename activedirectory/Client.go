 ...
 * @param    []*models.AddGroupsOrUsersRequest        body     parameter: Optional
 * @return	Returns the []*models.NonLOCALGroupOrUser response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) AddActiveDirectoryPrincipals (
            body []*models.AddGroupsOrUsersRequest) ([]*models.NonLOCALGroupOrUser, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal []*models.NonLOCALGroupOrUser
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @param    models.ObjectClass4Enum        objectClass          parameter: Optional
 ...
 * @return	Returns the []*models.ActiveDirectory response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) GetActiveDirectoryEntry (
            domains []string,
            tenantIds []string,
            allUnderHierarchy *bool) ([]*models.ActiveDirectory, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal []*models.ActiveDirectory
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @param    []*models.UpdatePreferredDomainControllerRequest        body     parameter: Required
 * @param    string                                                      name     parameter: Required
 * @return	Returns the *models.ActiveDirectory response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) UpdatePreferredDomainControllers (
            body []*models.UpdatePreferredDomainControllerRequest,
            name string) (*models.ActiveDirectory, error) {
//validating required parameters
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.ActiveDirectory = &models.ActiveDirectory{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @param    *models.UpdateMachineAccountsRequest        body     parameter: Required
 * @param    string                                          name     parameter: Required
 * @return	Returns the *models.ActiveDirectory response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) UpdateActiveDirectoryMachineAccounts (
            body *models.UpdateMachineAccountsRequest,
            name string) (*models.ActiveDirectory, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
 ...
 * @param    *models.UpdateLDAPProviderRequest        body     parameter: Required
 * @param    string                                       name     parameter: Required
 * @return	Returns the *models.ActiveDirectory response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) UpdateActiveDirectoryLdapProvider (
            body *models.UpdateLDAPProviderRequest,
            name string) (*models.ActiveDirectory, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
 ...
 * @param    *models.UpdateBlacklistedTrustedDomainRequest        body     parameter: Required
 * @param    string                                                   name     parameter: Required
 * @return	Returns the *models.ActiveDirectory response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) UpdateActiveDirectoryIgnoredTrustedDomains (
            body *models.UpdateBlacklistedTrustedDomainRequest,
            name string) (*models.ActiveDirectory, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
 ...
 * @param    *models.UpdateIDMappingInformationRequest        body     parameter: Required
 * @param    string                                               name     parameter: Required
 * @return	Returns the *models.ActiveDirectory response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) UpdateActiveDirectoryIdMapping (
            body *models.UpdateIDMappingInformationRequest,
            name string) (*models.ActiveDirectory, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
 ...
 * @param    *models.ActiveDirectory        body     parameter: Required
 * @return	Returns the  response from the API call
 */
func (me *ACTIVEDIRECTORY_IMPL) DeleteActiveDirectoryEntry (
            body *models.ActiveDirectory) (error) {
//validating required parameters
    if (body == nil){
...
func (me *ACTIVEDIRECTORY_IMPL) CreateActiveDirectoryEntry (
            body *models.ActiveDirectory) (*models.ActiveDirectory, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
}     //the endpoint path uri
