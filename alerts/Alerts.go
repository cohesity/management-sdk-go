...
type ALERTS interface {
    ...
    GetResolutions (int64, *int64, *int64, []string, *bool, []int64, []string) ([]*models.AlertResolution, error)
    ...
    GetAlerts (int64, *bool, []string, []models.AlertCategoryListGetAlertsEnum, *string, *string, *int64, []models.AlertSeverityListEnum, []string, []int64, *int64, []models.AlertStateListEnum, []int64) ([]*models.Alert, error)
