...
//validating required parameters
    ...
    _pathUrl := "/public/appInstances/{appInstanceId}/states"
 ...
 */
func (me *APPINSTANCE_IMPL) CreateLaunchAppInstance (
            body *models.LaunchAppInstance) (*models.AppInstanceIdParameterSpecifiesAppInstanceIdInPathParameter, error) {
//validating required parameters
    if (body == nil){
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.AppInstanceIdParameterSpecifiesAppInstanceIdInPathParameter = &models.AppInstanceIdParameterSpecifiesAppInstanceIdInPathParameter{}
    err = json.Unmarshal(_response.RawBody, &retVal)
