 ...
 * @return	Returns the *models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster response from the API call
 */
func (me *CLUSTERS_IMPL) GetExternalClientSubnets () (*models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster = &models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster{}
 ...
 * @param    *models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster        body     parameter: Optional
 * @return	Returns the *models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster response from the API call
 */
func (me *CLUSTERS_IMPL) UpdateExternalClientSubnets (
            body *models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster) (*models.SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster, error) {
    //the endpoint path uri
    _pathUrl := "/public/externalClientSubnets"
