 ...
 */
type EXPORT_IMPL struct {
     config configuration.CONFIGURATION
}

/**
 * Export metadata into Json files
 * @param    *models.ExportParameters        body     parameter: Required
 * @return	Returns the  response from the API call
 */
func (me *EXPORT_IMPL) CreateExportConfig (
            body *models.ExportParameters) (error) {
//validating required parameters
    if (body == nil){
        return errors.New("The parameter 'body' is a required parameter and cannot be nil.")
}     //the endpoint path uri
    _pathUrl := "/public/export/config"
