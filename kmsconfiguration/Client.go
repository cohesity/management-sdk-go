 ...
 * @return	Returns the []*models.GetKMSConfigurationResponseParameters response from the API call
 */
func (me *KMSCONFIGURATION_IMPL) GetKmsConfig (
            serverIp *string) ([]*models.GetKMSConfigurationResponseParameters, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.GetKMSConfigurationResponseParameters
...
func (me *KMSCONFIGURATION_IMPL) UpdateKmsConfig (
            body *models.KMSConfiguration) (*models.GetKMSConfigurationResponseParameters, error) {
    //the endpoint path uri
    _pathUrl := "/public/kmsConfig"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.GetKMSConfigurationResponseParameters = &models.GetKMSConfigurationResponseParameters{}
    err = json.Unmarshal(_response.RawBody, &retVal)
