 ...
 * @param    *models.UpdateLDAPProviderParameters        body     parameter: Required
 * @return	Returns the *models.LDAPProviderResponse response from the API call
 */
func (me *LDAPPROVIDER_IMPL) UpdateLdapProvider (
            body *models.UpdateLDAPProviderParameters) (*models.LDAPProviderResponse, error) {
 ...
 * @param    *models.LDAP        body     parameter: Required
 * @return	Returns the *models.LDAPProviderResponse response from the API call
 */
func (me *LDAPPROVIDER_IMPL) CreateLdapProvider (
            body *models.LDAP) (*models.LDAPProviderResponse, error) {
//validating required parameters
    if (body == nil){
        return nil,errors.New("The parameter 'body' is a required parameter and cannot be nil.")
}     //the endpoint path uri
...
func (me *LDAPPROVIDER_IMPL) GetLdapProvider (
            ...
            ids []int64) ([]*models.LDAPProviderResponse, error) {
    //the endpoint path uri
    _pathUrl := "/public/ldapProvider"
