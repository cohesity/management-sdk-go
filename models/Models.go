...
type ADObject struct {
    ...
    DestinationPropCount *int64          `json:"destinationPropCount,omitempty" form:"destinationPropCount,omitempty"` //Specifies the number of properties in AD Object in the Production AD.
    ...
    MismatchPropName     *string         `json:"mismatchPropName,omitempty" form:"mismatchPropName,omitempty"` //Specifies the name of the first property which differs in the AD Object
    ...
    SourcePropCount      *int64          `json:"sourcePropCount,omitempty" form:"sourcePropCount,omitempty"` //Specifies the number of properties in AD Object in the Snapshot AD.
}
...
type CompareAdObjectsRequest struct {
    RestoreTaskId             *int64          `json:"RestoreTaskId,omitempty" form:"RestoreTaskId,omitempty"` //Specifies the Restore Task Id corresponding to which we need to compare
    ...
    CaseSensitive             *bool           `json:"caseSensitive,omitempty" form:"caseSensitive,omitempty"` //Specifies the option to make comparison of attribute values case
    ...
    GuidPairs                 []*GuidPair     `json:"guidPairs,omitempty" form:"guidPairs,omitempty"` //Specifies the GuidPair of the AD Objects which we want to compare
...
type ComparedADObject struct {
    ...
    DestinationAttrCount *int64          `json:"destinationAttrCount,omitempty" form:"destinationAttrCount,omitempty"` //Specifies the number of attributes of AD Object in the Production AD.
    ...
    ErrorMessage         *string         `json:"errorMessage,omitempty" form:"errorMessage,omitempty"` //Specifies the error message while fetching the AD object.
    ExcludedAttrCount    *int64          `json:"excludedAttrCount,omitempty" form:"excludedAttrCount,omitempty"` //Specifies the number of attributes in AD Object which are excluded
    ...
    SourceAttrCount      *int64          `json:"sourceAttrCount,omitempty" form:"sourceAttrCount,omitempty"` //Specifies the number of properties of AD Object in the Snapshot AD.
...
/*
 * Structure for the custom type FileLockStatusParams
 */
type FileLockStatusParams struct {
...
type PrivilegeInfo struct {
    PrivilegeId         *int64          `json:"PrivilegeId,omitempty" form:"PrivilegeId,omitempty"` //Specifies unique id for a privilege. This number must be unique when
...
type SmbPermission struct {
    ...
    Mode              ModeSmbPermissionEnum `json:"mode,omitempty" form:"mode,omitempty"` //Specifies how the permission should be applied to folders and/or files.
...
type SourceSpecialParameter struct {
    ...
    OracleSpecialParameters   ApplicationSpecialParameters `json:"oracleSpecialParameters,omitempty" form:"oracleSpecialParameters,omitempty"` //Specifies additional special settings applicable for a Protection Source
...
type UpgradeClusterParameters struct {
    TargetSwVersion *string         `json:"targetSwVersion,omitempty" form:"targetSwVersion,omitempty"` //Specifies the target software version. If specified, all Nodes on the
}
...
type User struct {
    ...
    PrivilegeIds         *[]int64        `json:"privilegeIds,omitempty" form:"privilegeIds,omitempty"` //Array of Privileges.
