 ...
 * a multipart request.
 * @return	Returns the *models.UploadPackageResult response from the API call
 */
func (me *PACKAGES_IMPL) UploadPackage () (*models.UploadPackageResult, error) {
    //the endpoint path uri
    _pathUrl := "/public/packages/file"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.UploadPackageResult = &models.UploadPackageResult{}
    err = json.Unmarshal(_response.RawBody, &retVal)
