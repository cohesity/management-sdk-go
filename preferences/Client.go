 ...
 */
type PREFERENCES_IMPL struct {
     config configuration.CONFIGURATION
}

/**
 * List the preferences of the session user.
 * @return	Returns the []*models.UserPreferencesProtoUserPreferencesPreference response from the API call
 */
func (me *PREFERENCES_IMPL) GetUserPreferences () ([]*models.UserPreferencesProtoUserPreferencesPreference, error) {
    //the endpoint path uri
    _pathUrl := "/public/sessionUser/preferences"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.UserPreferencesProtoUserPreferencesPreference
 ...
 * @param    []*models.UserPreferencesProtoUserPreferencesPreference        body     parameter: Optional
 * @return	Returns the []*models.UserPreferencesProtoUserPreferencesPreference response from the API call
 */
func (me *PREFERENCES_IMPL) UpdateUserPreferences (
            body []*models.UserPreferencesProtoUserPreferencesPreference) ([]*models.UserPreferencesProtoUserPreferencesPreference, error) {
    //the endpoint path uri
    _pathUrl := "/public/sessionUser/preferences"
