 ...
 * @param    []models.Environments2Enum        environments                    parameter: Optional
 ...
 * @return	Returns the *models.GetRegistrationInformationResponse response from the API call
 */
 ...
 * @return	Returns the []*models.NodeInAProtectionSourcesTree response from the API call
 */
func (me *PROTECTIONSOURCES_IMPL) ListProtectionSourcesRootNodes (
            environments []models.Environments2Enum,
            environment *string,
            id *int64) ([]*models.NodeInAProtectionSourcesTree, error) {
    //the endpoint path uri
 ...
 * @param    models.Environment2Enum        environment           parameter: Required
 * @param    int64                              id                    parameter: Required
 * @param    *bool                              allUnderHierarchy     parameter: Optional
 * @return	Returns the []*models.ProtectedVMInformation response from the API call
 */
 ...
 * @param    *bool                                         allUnderHierarchy               parameter: Optional
 * @param    *int64                                        id                              parameter: Optional
 * @param    []models.ExcludeOffice365TypesEnum        excludeOffice365Types           parameter: Optional
 * @param    *bool                                         includeDatastores               parameter: Optional
 * @param    *bool                                         includeVMFolders                parameter: Optional
 * @param    *bool                                         includeEntityPermissionInfo     parameter: Optional
 * @param    []string                                      sids                            parameter: Optional
 * @param    []string                                      tenantIds                       parameter: Optional
 * @param    []models.ExcludeTypesEnum                 excludeTypes                    parameter: Optional
 ...
 * @param    *models.UpgradePhysicalServerAgentsRequest        body     parameter: Optional
 * @return	Returns the *models.StatusOfPhysicalUpgradeRequest response from the API call
 */
func (me *PROTECTIONSOURCES_IMPL) CreateUpgradePhysicalAgents (
            body *models.UpgradePhysicalServerAgentsRequest) (*models.StatusOfPhysicalUpgradeRequest, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.StatusOfPhysicalUpgradeRequest = &models.StatusOfPhysicalUpgradeRequest{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @param    models.HostType8Enum        hostType     parameter: Required
...
func (me *PROTECTIONSOURCES_IMPL) GetDownloadPhysicalAgent (
            hostType models.HostType8Enum,
            pkgType models.PkgTypeEnum) ([]int64, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //process optional query parameters
    _queryBuilder, err = apihelper.AppendUrlWithQueryParameters(_queryBuilder, map[string]interface{} {
        "hostType" : models.HostType8EnumToValue(hostType),
