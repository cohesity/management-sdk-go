 ...
 * @return	Returns the *models.ReplicationEncryptionKey response from the API call
 */
func (me *REMOTECLUSTER_IMPL) GetReplicationEncryptionKey () (*models.ReplicationEncryptionKey, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models.ReplicationEncryptionKey = &models.ReplicationEncryptionKey{}
...
func (me *REMOTECLUSTER_IMPL) GetRemoteClusters (
            ...
            clusterIds []int64,
            clusterNames []string) ([]*models.RemoteCluster, error) {
    //the endpoint path uri
