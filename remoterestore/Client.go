 ...
 * @return	Returns the []*models.RemoteVaultSearchInformation response from the API call
 */
func (me *REMOTERESTORE_IMPL) ListRemoteVaultSearchJobs () ([]*models.RemoteVaultSearchInformation, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal []*models.RemoteVaultSearchInformation
 ...
 * NOTE: A Vault is equivalent to an External Target in the Cohesity Dashboard.
 * A search Job is equivalent to a search task in the Cohesity Dashboard.
 * @param    *models.CreateRemoteVaultSearchRequest        body     parameter: Required
 * @return	Returns the *models.RemoteVaultSearchJobUid response from the API call
 */
func (me *REMOTERESTORE_IMPL) CreateRemoteVaultSearchJob (
            body *models.CreateRemoteVaultSearchRequest) (*models.RemoteVaultSearchJobUid, error) {
//validating required parameters
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.RemoteVaultSearchJobUid = &models.RemoteVaultSearchJobUid{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * This is part of the CloudRetrieve functionality for finding and restoring
 * archived data from remote Vaults to an alternative (non-original) Cluster.
 * @param    *models.SearchJobStopRequest        body     parameter: Required
...
func (me *REMOTERESTORE_IMPL) ListRemoteVaultSearchJobById (
            id int64) (*models.RemoteVaultSearchInformation, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.RemoteVaultSearchInformation = &models.RemoteVaultSearchInformation{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * @return	Returns the *models.RemoteVaultSearchJobResult response from the API call
 */
func (me *REMOTERESTORE_IMPL) GetRemoteVaultSearchJobResults (
            ...
            pageCount *int64,
            clusterName *string,
            cookie *string) (*models.RemoteVaultSearchJobResult, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models.RemoteVaultSearchJobResult = &models.RemoteVaultSearchJobResult{}
    err = json.Unmarshal(_response.RawBody, &retVal)
 ...
 * This is part of the CloudRetrieve functionality for finding and restoring
 * archived data from remote Vaults to an alternative (non-original) Cluster.
 * @param    *models.CreateRemoteVaultRestoreTaskRequest        body     parameter: Required
 * @return	Returns the *models.UniqueGlobalId response from the API call
 */
