 ...
 * @return	Returns the *models.DomainViewBox response from the API call
 */
func (me *VIEWBOXES_IMPL) GetViewBoxById (
            id int64) (*models.DomainViewBox, error) {
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models.DomainViewBox = &models.DomainViewBox{}
 ...
 * @param    int64                                          id       parameter: Required
 * @param    *models.StorageDomainViewBoxRequest        body     parameter: Required
 * @return	Returns the *models.DomainViewBox response from the API call
 */
func (me *VIEWBOXES_IMPL) UpdateViewBox (
            id int64,
            body *models.StorageDomainViewBoxRequest) (*models.DomainViewBox, error) {
...
func (me *VIEWBOXES_IMPL) GetViewBoxes (
            ...
            ids []int64,
            names []string,
            clusterPartitionIds []int64) ([]*models.DomainViewBox, error) {
    //the endpoint path uri
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal []*models.DomainViewBox
    err = json.Unmarshal(_response.RawBody, &retVal)
